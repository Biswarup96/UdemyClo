...
const Topbar = () => {
  ...
  return (
    <div className="flex justify-between items-center p-5 " style={{background:"white", position:"sticky",top:"0px", width:'100%', zIndex:"1", boxShadow: "#c2c0c0 1px 2px 13px 3px"}}>
      <Link href="/">
